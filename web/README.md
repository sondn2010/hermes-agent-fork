...
Browser-based dashboard for managing CNCNS Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “CNCNS Agent” — mixed case, no Mondwest, no `text-display` |
