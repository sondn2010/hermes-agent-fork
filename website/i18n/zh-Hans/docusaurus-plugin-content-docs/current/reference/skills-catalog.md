...
sidebar_position: 5
title: "内置技能目录"
description: "随 CNCNS Agent 附带的内置技能目录"
---
...
| [`hermes-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) | 配置、扩展或贡献 CNCNS Agent。 | `autonomous-ai-agents/hermes-agent` |
