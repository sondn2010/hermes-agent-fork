...
sidebar_position: 5
title: "WhatsApp"
description: "Set up CNCNS Agent as a WhatsApp bot via the built-in Baileys bridge"
---
...
- Agent responses are prefixed with "⚕ **CNCNS Agent**" by default. You can customize or disable this in `config.yaml`:
