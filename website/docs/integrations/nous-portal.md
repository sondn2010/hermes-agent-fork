...
sidebar_position: 1
title: "Nous Portal"
description: "One subscription, 300+ frontier models, and the Tool Gateway — the recommended way to run CNCNS Agent"
---
...
The same subscription unlocks the [Tool Gateway](/user-guide/features/tool-gateway), which routes CNCNS Agent's tool calls through Nous-managed infrastructure. Five backends, one login:
