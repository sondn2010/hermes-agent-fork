...
description: "Which operating systems, distribution methods, and features CNCNS Agent supports."
---

# Platform Support

CNCNS Agent maintains support for many platforms and distribution methods, but we can't support every possible install method.
