...
description: "Install and deploy CNCNS Agent with Nix — from quick `nix run` to fully declarative NixOS module with container mode"
---
...
CNCNS Agent ships a Nix flake & a NixOS module.
