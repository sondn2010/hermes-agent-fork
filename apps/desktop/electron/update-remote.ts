 ...
 *
 * A public install can end up with `origin=git@github.com:sondn2010/hermes-agent-fork.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/sondn2010/hermes-agent-fork.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/sondn2010/hermes-agent-fork'
