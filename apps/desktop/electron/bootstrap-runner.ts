 ...
 * bootstrap-runner.ts
 *
 * Drives apps/desktop's first-launch install of CNCNS Agent by spawning
...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/sondn2010/hermes-agent-fork/${ref}/scripts/${scriptName}`
