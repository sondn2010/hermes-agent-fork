# ============================================================================
# CNCNS Agent Installer for Windows
# ============================================================================
...
$RepoUrlSsh = "git@github.com:sondn2010/hermes-agent-fork.git"
$RepoUrlHttps = "https://github.com/sondn2010/hermes-agent-fork.git"
$PythonVersion = "3.11"
...
function Write-Banner {
    ...
    Write-Host "|             * CNCNS Agent Installer                    |" -ForegroundColor Magenta
    Write-Host "+---------------------------------------------------------+" -ForegroundColor Magenta
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                $repoBaseUrl = $RepoUrlHttps -replace '\.git$', ''
                if ($Commit) {
                    $zipUrl = "$repoBaseUrl/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "$repoBaseUrl/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "$repoBaseUrl/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
