...
.. code-block:: yaml
    ...
    branding:
      agent_name: "CNCNS Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "CNCNS Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to CNCNS Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
